# Design-Matrix Flowchart — Reward-Encoding Neurons across Learning

*The ridge encoding-model design matrix (X: stimulus · position · velocity ·
reward/cue lag bases) this flowchart used to document is retired — see
docs/method.md for why. Superseded by the sole method below, identical to
method-flowchart.md.*
